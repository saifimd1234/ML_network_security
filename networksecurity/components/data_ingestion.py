...
class DataIngestion:
    """
    Class for handling data ingestion operations from MongoDB to a feature store and 
    ...
    def __init__(self, data_ingestion_config: DataIngestionConfig):
        ...
        Args:
            data_ingestion_config (DataIngestionConfig): Configuration object containing 
                parameters for data ingestion such as database name, collection name, 
                file paths, and split ratio.
    ...
    def export_collection_as_dataframe(self):
        ...
        Raises:
            NetworkSecurityException: If data export fails.
        """
        try:
    ...
    def export_data_into_feature_store(self, dataframe: pd.DataFrame):
        ...
        Raises:
            NetworkSecurityException: If saving to feature store fails.
        """
        try:
    ...
    def split_data_as_train_test(self, dataframe: pd.DataFrame):
        ...
        Raises:
            NetworkSecurityException: If splitting or saving the data fails.
        """
        try:
    ...
    def initiate_data_ingestion(self):
        ...
        Raises:
            NetworkSecurityException: If any part of the data ingestion process fails.
        """
        try:
